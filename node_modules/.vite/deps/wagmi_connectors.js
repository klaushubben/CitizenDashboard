import {
  ...
  call_exports,
  mini_exports
} from "./chunk-YRSOPTWC.js";
import "./chunk-O7OA7YMM.js";
...
import {
  ...
  polygonAmoy,
  sepolia
} from "./chunk-RS4ZB2XY.js";
import "./chunk-3TOSMCAS.js";
import {
...
import {
  withRetry,
  withTimeout
} from "./chunk-GXTFCK6H.js";
import "./chunk-MBD6RRGJ.js";
import "./chunk-LWLUVSGB.js";
import "./chunk-XFEEMWHW.js";
import "./chunk-7RZLNPY6.js";
import {
  ...
  keccak_256,
  numberToHex
} from "./chunk-25EMKGWL.js";
import "./chunk-P3I7OWOF.js";
import {
  __commonJS,
  __export,
  __toESM
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createBaseAccountSDK } = await import("./dist-G6XA4LVK.js");
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createCoinbaseWalletSDK } = await import("./dist-7KBIL6RI.js");
    ...
    return {
      ...
      async getPortoInstance() {
        porto_promise ?? (porto_promise = (async () => {
          const { Porto } = await import("./dist-KWZRAWI2.js");
          return Porto.create({
            ...parameters,
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      ...
      if (!isIframe)
        return;
      if (!provider_) {
        const { default: SDK } = await import("./esm-LOFLDABP.js");
    ...
    async getProvider({ chainId } = {}) {
      ...
      async function initProvider() {
        ...
        if (!optionalChains.length)
          return;
        const { EthereumProvider } = await import("./index.es-DIGBHXTL.js");
